...
const submissionSchema = Joi.object({
    ...
    parents_phone: phone
        .required()
        .messages({ "any.required": "Parent's phone is required" }),
    whatsapp_number: phone
        .required()
        .messages({ "any.required": "WhatsApp number is required" }),
    email: Joi.string()
        .trim()
        .email()
        .empty("")
    ...
    school_standard_id: Joi.when("student_type", {
        ...
        then: Joi.string()
            .trim()
            .required()
            .messages({ "any.required": "Select your standard" }),
    ...
    school_board_id: Joi.when("student_type", {
        ...
        then: Joi.string()
            .trim()
            .required()
            .messages({ "any.required": "Select your board" }),
        otherwise: Joi.string().trim().empty("").optional(),
    }),
    ...
    college_degree_id: Joi.when("student_type", {
        ...
        then: Joi.string()
            .trim()
            .required()
            .messages({ "any.required": "Select your degree" }),
        otherwise: Joi.string().trim().empty("").optional(),
    }),
    ...
    other_degree_name: Joi.when("student_type", {
        ...
        then: Joi.when("college_degree_id", {
            ...
            then: Joi.string()
                ...
                .max(250)
                .required()
                .messages({ "any.required": "Please enter your degree name" }),
